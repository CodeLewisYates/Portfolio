...
const Services = (props) => {
  return (
    <div className="Services">
      ...
      <div className="serviceBox landing">
        <h2>Landing Pages</h2>
        <p>Aesthetically pleasing, unique and dynamic landing pages!</p>
      </div>

      <div className="serviceBox api">
        <h2>APIs</h2>
        <p>Building and connecting you to your servers and databases!</p>
      </div>

      <div className="serviceBox ssr">
        <h2>Server Side Rendered Site</h2>
        <p>
          Multi - page, dynamic sites that pop up on google searches, connected
          to your database!
        </p>
      </div>

      <div className="serviceBox seamless">
